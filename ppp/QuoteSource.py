...
class QuoteSource:
    ...
    def __init__(self, token, trade_date, before):
        ...
        rows = requests.get(f'https://web.ifzq.gtimg.cn/appstock/app/fqkline/get?param=sh000300,day,{start},{end},30,').json()['data']['sh000300']['day']
